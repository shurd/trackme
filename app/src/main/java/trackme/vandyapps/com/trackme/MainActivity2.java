...
public class MainActivity2 extends ActionBarActivity implements
        ...
        query.getInBackground(myId, new GetCallback<ParseObject>() {
            public void done(ParseObject object, ParseException e) {
                if (e == null) {
                    ...
                    //object.put("Lat", Arrays.asList(36.5,36.55,36.6));
    ...
    protected void createLocationRequest() {
        ...
        mLocationRequest.setInterval(1000);//UPDATE_INTERVAL_IN_MILLISECONDS);
